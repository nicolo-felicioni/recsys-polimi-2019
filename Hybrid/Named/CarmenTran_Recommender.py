...
from Hybrid.Named.CarmenTran.Hybrid3ScoreRecommender import Hybrid3ScoreRecommender
...
class CarmenTran_Recommender(BaseRecommender):
    """CarmenTran_Recommender recommender"""

    RECOMMENDER_NAME = "CarmenTran_Recommender"
    ...
    def fit(self):
        ...
        self.warm_recommender.fit(alpha_beta_ratio=0.2, alpha_gamma_ratio=0.15)
